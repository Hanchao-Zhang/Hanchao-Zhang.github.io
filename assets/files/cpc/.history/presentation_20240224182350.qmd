...
\begin{align*}
    \mathbf B = \underset{\mathbf B \in \mathcal V_q(\mathbb R^p)}{\text{argmin}} \ \big\Vert \mathbf \Psi_i - \mathbf B \mathbf B^T \mathbf \Psi_i \mathbf B \mathbf B^T \big\Vert_F^2
\end{align*}
