...
:::{.fragment}
**Definition 3:** the hyperplane () that best approximates $\mathbf \psi$ is defined as
\begin{align}\label{sec3:cpcestimation}
	& \B(\bPsi) = \underset{{\mathbf B \in \mathcal V_p(\R^p)}}{\arg\min} \ \E \left\{ \left\Vert \bPsi - \mathcal P_{\B}\left( \bPsi \right) \right\Vert_{\F}^2 \right\} 
\end{align}
:::
