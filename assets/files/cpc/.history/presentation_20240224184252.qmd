...
\begin{align}\label{sec3:cpcestimation}
	& \mathbf B(\mathbf \Psi) = \underset{{\mathbf B \in \mathcal V_p(\R^p)}}{\arg\min} \ \mathcal E \left\{ \left\Vert \mathbf \Psi - \mathcal P_{\mathbf B}\left( \mathbf \Psi \right) \right\Vert_{F}^2 \right\} 
\end{align}
:::
