...
\end{align}
defines the princpal and self-consistent tensors which is also the common principal component subspace, where $\mathbb D^+$ is the set of all diagonal matrices with 
:::
