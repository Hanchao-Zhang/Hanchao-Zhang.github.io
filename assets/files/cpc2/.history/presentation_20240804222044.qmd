...
\end{align}
defines the princpal and self-consistent tensors, where $\mathbb D^+$ is the set of all diagonal matrices with non-negative values.
:::
...
\begin{align*}
    ...
    \begin{align*}
        ...
        \end{bmatrix} \\
        \\
        & \mathbf E_i \sim \mathcal W_2(\mathbf I, 10),
\end{align*}
