---
title: "Common Principal Component Subspace and Clustering Symmetric Positive Semi-Definite Matrices"
author:
  - name: Hanchao Zhang
...
:::{.column width="50%"}
  ...
  ![](./pics/QRCODE.png){#fig:K-Tensors width=50%}
:::

:::{.column width="50%"}
  ![](./pics/Profile from QR Code Creator.png){#fig:K-Tensors width=50%}
:::
