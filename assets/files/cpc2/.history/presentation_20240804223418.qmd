...
:::{.incremental}Key Brain Regions: Significant links between clustering outcomes and anatomical structures like the right parahippocampal, middle temporal gyri, and motor function areas, associated with mental disorders such as Alzheimer’s, schizophrenia, Parkinson’s disease, and dementia.
	•	Cognitive Metrics: Task-related metrics reflecting cognitive load and emotional response timings are indicative of susceptibility to anxiety, depression, and mood disorders.
	•	Cognitive Fluidity: Scores measuring fluid intelligence correlate with susceptibility to conditions like OCD, ASD, and schizophrenia, highlighting the role of cognitive flexibility in mental health.
:::
