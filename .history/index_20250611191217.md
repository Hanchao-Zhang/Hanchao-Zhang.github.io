...
<div class="timeline-container">
  ...
  <div class="timeline-entry">
    ...
    <ul style="margin-top: -7px; padding-left: 20px;">
      <li>Supervised by Prof. Thaddeus Tarpe</li>
      <li>Focused on functional and imaging data analysis</li>
      <li>Confronted challenges in clustering and subgroup identification</li>
    </ul>
    </div>
  </div>
</div>
