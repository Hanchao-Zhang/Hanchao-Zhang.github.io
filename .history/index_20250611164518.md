...
<div style="display: flex; flex-wrap: wrap; gap: 20px;">
  ...
  <div style="flex: 1; min-width: 300px;">
    ...
    <ul style="list-style: none; padding-left: 0;">
      <li><i class="fas fa-university"></i> <strong>Visiting Researcher</strong>, Columbia University (2023)
        <ul style="list-style: none; padding-left: 20px;">
          <li>- Collaborated on advanced statistical methodologies</li>
        </ul>
      </li>
      <li><i class="fas fa-university"></i> <strong>Visiting Researcher</strong>, Johns Hopkins University (2019 - 2020)
        <ul style="list-style: none; padding-left: 20px;">
          <li>- Worked on applied mathematics and statistics projects</li>
        </ul>
      </li>
      <li><i class="fas fa-graduation-cap"></i> <strong>M.S. Research</strong>, Cornell University (2017 - 2018)
        <ul style="list-style: none; padding-left: 20px;">
          <li>- Focused on biostatistics and data science applications</li>
          <li>- Advised by Prof. Iván Díaz</li>
        </ul>
      </li>
    </ul>
  </div>
