...
<div style="display: flex; flex-wrap: wrap; gap: 20px;">
  ...
  <div style="display: flex; flex-direction: column; gap: 2px;">
    ...
    <div class="timeline-entry">
      ...
      <h3><i class="fas fa-graduation-cap"></i> Visiting Student in Statistics, Columbia University</h3>
    </div>

    <div class="timeline-entry">
      <div class="year-circle">2020</div>
      <h3><i class="fas fa-graduation-cap"></i> Visiting Student in Applied Mathematics & Statistics, Johns Hopkins</h3>
    </div>
