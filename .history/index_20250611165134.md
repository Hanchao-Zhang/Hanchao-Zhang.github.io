...
<div style="max-width: 800px; position: relative;">
  ...
  <div style="position: relative; padding-left: 30px;">
    ...
    <div style="position: absolute; left: 15px; top: 25px; height: 95px; width: 2px; background: #007bff;"></div>
    ...
    <div style="position: absolute; left: 5px; top: 150px; width: 0; height: 0; border-left: 10px solid transparent; border-right: 10px solid transparent; border-top: 10px solid #007bff;"></div>
    <div style="position: absolute; left: 15px; top: 150px; width: 10px; height: 2px; background: #007bff;"></div>
