...
<div style="display: flex; flex-wrap: wrap; gap: 20px;">
  <div class="timeline-container" style="flex: 1; min-width: 300px;">
    ...
    <div class="timeline-entry">
      ...
      <h3><i class="fas fa-graduation-cap"></i> Ph.D. in Biostatistics, New York University</h3>
      <div style="font-size: 0.9rem; color: #666;">Ph.D. in Biostatistics</div>
    </div>

    <div class="timeline-entry">
      <div class="year-circle">2023</div>
      <h3><i class="fas fa-briefcase"></i> Visiting Student in Statistics, Columbia University</h3>
    </div>

    <div class="timeline-entry">
      <div class="year-circle">2020</div>
      <h3><i class="fas fa-briefcase"></i> Visiting Student in Biostatistics, Johns Hopkins University</h3>
    </div>

    <div class="timeline-entry">
      <div class="year-circle">2018</div>
      <h3><i class="fas fa-university"></i> M.S. in Biostatistics and Data Science, Cornell University</h3>
    </div>

    <div class="timeline-entry">
      <div class="year-circle">2017</div>
      <h3><i class="fas fa-book"></i> B.S. in International Finance, Capital University of Economics and Business</h3>
    </div>
  </div>
