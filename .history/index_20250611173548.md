...
<style>
  .timeline-container {
    ...
    <div style="position: relative; margin-bottom: 30px;">
      <div style="position: absolute; left: -25px; top: 5px; width: 20px; height: 20px; border-radius: 50%; background: #57068C; border: 3px solid white;"></div>
    ...
    <!-- Connecting arrow -->
    <div style="position: absolute; left: 15px; top: 120px; height: 30px; width: 2px; background: #57068C;"></div>
    <div style="position: absolute; left: 5px; top: 120px; width: 0; height: 0; border-left: 10px solid transparent; border-right: 10px solid transparent; border-bottom: 10px solid #57068C;"></div>
    <div style="position: absolute; left: 15px; top: 120px; width: 10px; height: 2px; background: #57068C;"></div>
