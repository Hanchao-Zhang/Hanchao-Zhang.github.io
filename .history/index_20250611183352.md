...
<div class="timeline-entry">
  ...
  <div>
    <div style="font-size: 0.9rem; color: #666;">New York University</div>
    <h3><i class="fas fa-graduation-cap"></i> Ph.D. in Biostatistics</h3>
  </div>
</div>
...
<div class="timeline-entry">
  ...
  <div>
    <div style="font-size: 0.9rem; color: #666;">Columbia University</div>
    <h3><i class="fas fa-briefcase"></i> Visiting Student in Statistics</h3>
  </div>
</div>
...
<div class="timeline-entry">
  ...
  <div>
    <div style="font-size: 0.9rem; color: #666;">Johns Hopkins University</div>
    <h3><i class="fas fa-briefcase"></i> Visiting Student in Biostatistics</h3>
  </div>
</div>
...
<div class="timeline-entry">
  ...
  <div>
    <div style="font-size: 0.9rem; color: #666;">Cornell University</div>
    <h3><i class="fas fa-university"></i> M.S. in Biostatistics and Data Science</h3>
  </div>
</div>
...
<div class="timeline-entry">
  ...
  <div>
    <div style="font-size: 0.9rem; color: #666;">Capital University of Economics and Business</div>
    <h3><i class="fas fa-book"></i> B.S. in International Finance</h3>
  </div>
</div>
